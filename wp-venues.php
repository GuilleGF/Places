...
require_once(dirname(__FILE__) . "/src/google-places-api.php");
...
function places_meta_box_callback()
{
    ...
    include_once(dirname(__FILE__) . '/assets/html/search-place-post.php');
...
function places_save_meta_box_data($post_id)
{
    ...
    //_WP_Places_meta_places_id, _WP_Places_meta_hours, _WP_Places_meta_reviews, _WP_Places_meta_closed,
    // _WP_Places_meta_lat, _WP_Places_meta_lon,
